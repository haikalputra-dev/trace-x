...
@Component({
  selector: 'app-production-machine-utility-label',
  templateUrl: './production-machine-utility-label.component.html',
  styleUrls: ['./production-machine-utility-label.component.scss'],
  animations: [slideInLeftDetail, slideInRightDetail],
})
export class ProductionMachineUtilityLabelComponent {
  ...
  ngOnInit() {
    ...
    this.onTabChange('', 'air_compressor_8_bar_label');
  }
  onTabChange(event: any, section: any) {
    this.dataSections = [];
    if (section == 'air_compressor_8_bar_label') {
