...
@Component({
  selector: 'app-production-machine-utility-caser',
  templateUrl: './production-machine-utility-caser.component.html',
  styleUrls: ['./production-machine-utility-caser.component.scss'],
  animations: [slideInLeftDetail, slideInRightDetail],
})
export class ProductionMachineUtilityCaserComponent {
  ...
  ngOnInit() {
    ...
    this.onTabChange('', 'air_compressor_8_bar_caser');
  }
  onTabChange(event: any, section: any) {
    this.dataSections = [];
    if (section == 'air_compressor_8_bar_caser') {
