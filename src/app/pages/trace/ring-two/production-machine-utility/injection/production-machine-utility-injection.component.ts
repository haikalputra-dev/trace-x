...
@Component({
  selector: 'app-production-machine-utility-injection',
  templateUrl: './production-machine-utility-injection.component.html',
  styleUrls: ['./production-machine-utility-injection.component.scss'],
  animations: [slideInLeftDetail, slideInRightDetail],
})
export class ProductionMachineUtilityInjectionComponent {
  ...
  ngOnInit() {
    ...
    this.onTabChange('', 'chiller_injection');
  }
  onTabChange(event: any, section: any) {
    this.dataSections = [];
    if (section == 'chiller_injection') {
