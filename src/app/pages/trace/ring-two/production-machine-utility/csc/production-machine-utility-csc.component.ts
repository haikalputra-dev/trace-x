...
@Component({
  selector: 'app-production-machine-utility-csc',
  templateUrl: './production-machine-utility-csc.component.html',
  styleUrls: ['./production-machine-utility-csc.component.scss'],
  animations: [slideInLeftDetail, slideInRightDetail],
})
export class ProductionMachineUtilityCscComponent {
  ...
  ngOnInit() {
    ...
    this.onTabChange('', 'air_compressor_8_bar_csc');
  }
  onTabChange(event: any, section: any) {
    this.dataSections = [];
    if (section == 'air_compressor_8_bar_csc') {
