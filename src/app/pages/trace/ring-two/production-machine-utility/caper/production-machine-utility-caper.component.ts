...
@Component({
  selector: 'app-production-machine-utility-caper',
  templateUrl: './production-machine-utility-caper.component.html',
  styleUrls: ['./production-machine-utility-caper.component.scss'],
  animations: [slideInLeftDetail, slideInRightDetail],
})
export class ProductionMachineUtilityCaperComponent {
  ...
  ngOnInit() {
    ...
    this.onTabChange('', 'air_compressor_8_bar_caper');
  }
  onTabChange(event: any, section: any) {
    this.dataSections = [];
    if (section == 'air_compressor_8_bar_caper') {
