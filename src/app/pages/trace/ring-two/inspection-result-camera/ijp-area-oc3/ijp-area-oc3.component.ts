...
@Component({
  selector: 'app-inspection-camera-ijp-area-oc3',
  templateUrl: './ijp-area-oc3.component.html',
  styleUrls: ['./ijp-area-oc3.component.scss'],
  animations: [slideInLeftDetail, slideInRightDetail]
})
export class IjpAreaOc3Component {
  ...
  ngOnInit(){
    ...
    this.fetchDataInspectionCamera('inspection_camera_oc3_ijp', 'IJP Area')
  }
