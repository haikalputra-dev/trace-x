...
@Component({
  selector: 'app-inspection-camera-label-area-oc3',
  templateUrl: './label-area-oc3.component.html',
  styleUrls: ['./label-area-oc3.component.scss'],
  animations: [slideInLeftDetail, slideInRightDetail],
})
export class LabelAreaOc3Component {
  ...
  ngOnInit(){
    ...
    this.fetchDataInspectionCamera('inspection_camera_oc3_label', 'Label Area')
  }
