...
@Component({
  selector: 'app-machine-detail-ring-one',
  templateUrl: './machine-detail-ring-one.component.html',
  styleUrls: ['./machine-detail-ring-one.component.scss'],
  animations: [slideInLeftDetail, slideInRightDetail],
})
export class MachineDetailRingOneComponent {
  ...
  ngOnInit() {
    ...
    this.breadCrumbItems = [
      { label: 'Traceability' },
      { label: 'Detail' },
      { label: 'Machine Ring One', active: true },
    ];
    ...
    this.dataPacking = this.dataService.getDataPacking().data;
