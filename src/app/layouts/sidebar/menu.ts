...
export const MENU: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      {
        id: 5,
        label: 'MENUITEMS.MASTERDATA.LIST.LINE',
        link: '/master-data/line',
        parentId: 3,
      },
      {
        id: 6,
        label: 'MENUITEMS.MASTERDATA.LIST.PRODUCT',
        link: '/master-data/product',
        parentId: 3,
      },
      {
        id: 7,
        label: 'MENUITEMS.MASTERDATA.LIST.DATABASE',
        link: '/master-data/database',
        parentId: 3,
      },
      {
        id: 8,
        label: 'MENUITEMS.MASTERDATA.LIST.DATA-SOURCE',
        link: '/master-data/data-source',
        parentId: 3,
      },
      {
        id: 9,
        label: 'MENUITEMS.MASTERDATA.LIST.STANDARD',
        link: '/master-data/standard',
        parentId: 3,
      },
    ],
  },
